...
export default function NewPassword() {
  ...
  if (!isValidToken) {
    return <div>Invalid or expired reset link. Please request a new password reset</div>
  }
...
//           disabled={!isMatching || Object.values(validationErrors).some(Boolean)}
//         >
//           Submit
//         </button>

//         {/* Display final validated password */}
//         {finalPassword && (
//           <div className="mt-4 p-3 bg-green-100 text-green-800 rounded">
//             Password successfully validated!
//           </div>
